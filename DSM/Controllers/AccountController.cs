...
namespace DSMF.Controllers
{
    ...
    public class AccountController : BasicController
    {
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ...
            en = cen.ReadOID(userName);
            /*if(en.Tipo==TipoUsuarioEnum.Administrador)
                ViewBag.tip = en.Tipo; Nuestro usuario no tiene Tipo. para eso hay que llamar create de ADMINISTRADOR*/
            SessionClose();
            return View();
        }
        ...
        {//TODO, todo esto ha sido generado por visual
